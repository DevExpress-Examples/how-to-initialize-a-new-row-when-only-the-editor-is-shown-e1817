...
Namespace InitNewRow_Editing
    ...
    Public Class InitNewRowOnEditingBehavior
        ...
        Protected Overrides Sub OnAttached()
            MyBase.OnAttached()
            AssociatedObject.FocusedRowHandleChanged += AddressOf OnFocusedRowHandleChanged
        ...
        Private Sub OnFocusedRowHandleChanged(ByVal sender As Object, ByVal e As FocusedRowHandleChangedEventArgs)
            If Not isLocked AndAlso AssociatedObject.FocusedRowHandle Is GridControl.NewItemRowHandle Then
                isLocked = True
